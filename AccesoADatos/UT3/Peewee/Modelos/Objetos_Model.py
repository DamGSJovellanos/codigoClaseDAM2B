...
class ObjetoModel(BaseModel):
    ...
    id_ubicacion = ForeignKeyField(UbicacionModel, backref='ubicacion_objeto')
    id_personaje_dropea = ForeignKeyField(PersonajeModel, backref='personaje_dropea')
    id_enemigo_dropea = ForeignKeyField(EnemigoModel, backref='enemigo_dropea')
